...
/// Size: 0x06B0 (1712 bytes) (0x000678 - 0x0006B0) align 16 MaxSize: 0x06B0
class UFoliageInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{ 
public:
	SDK_UNDEFINED(16,439) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                          // 0x0678   (0x0010)  
	SDK_UNDEFINED(16,440) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                         // 0x0688   (0x0010)  
...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x35f6e20] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);          // [0x35f6ce0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x03D0 (976 bytes) (0x0003B0 - 0x0003D0) align 8 MaxSize: 0x03D0
...
/// Size: 0x0290 (656 bytes) (0x000230 - 0x000290) align 8 MaxSize: 0x0290
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x35f6ac0] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void Simulate(int32_t NumSteps);                                                                                         // [0x35f6f80] Final|Native|Public|BlueprintCallable 
};
