...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                            // [0x19e5a20] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* MeshComp);                                              // [0x19e5980] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* MeshComp);                                                                 // [0x19e58e0] Final|Native|Public|BlueprintCallable|Const 
};
