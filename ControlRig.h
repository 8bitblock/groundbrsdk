...
/// Size: 0x0650 (1616 bytes) (0x000028 - 0x000650) align 8 MaxSize: 0x0650
class UControlRig : public UObject
{ 
public:
	unsigned char                                      UnknownData00_8[0x1D];                                      // 0x0028   (0x001D)  MISSED
	...
	TWeakObjectPtr<class UControlRigGizmoLibrary*>     GizmoLibrary;                                               // 0x03B8   (0x0008)  
	...
	// void SetInteractionRigClass(class UClass* InInteractionRigClass);                                                        // [0x9bde20] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRig.SetInteractionRig
	// void SetInteractionRig(class UControlRig* InInteractionRig);                                                             // [0x9bdd90] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRig.GetInteractionRigClass
	// class UClass* GetInteractionRigClass();                                                                                  // [0x9bc9e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRig.GetInteractionRig
	// class UControlRig* GetInteractionRig();                                                                                  // [0x9bc9c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x0530 (1328 bytes) (0x000450 - 0x000530) align 16 MaxSize: 0x0530
class UControlRigComponent : public UPrimitiveComponent
{ 
public:
	class UClass*                                      ControlRigClass;                                            // 0x0450   (0x0008)  
	SDK_UNDEFINED(16,394) /* FMulticastInlineDelegate */ __um(OnPostInitializeDelegate);                           // 0x0458   (0x0010)  
	SDK_UNDEFINED(16,395) /* FMulticastInlineDelegate */ __um(OnPreSetupDelegate);                                 // 0x0468   (0x0010)  
	SDK_UNDEFINED(16,396) /* FMulticastInlineDelegate */ __um(OnPostSetupDelegate);                                // 0x0478   (0x0010)  
	SDK_UNDEFINED(16,397) /* FMulticastInlineDelegate */ __um(OnPreUpdateDelegate);                                // 0x0488   (0x0010)  
	SDK_UNDEFINED(16,398) /* FMulticastInlineDelegate */ __um(OnPostUpdateDelegate);                               // 0x0498   (0x0010)  
	TArray<FControlRigComponentMappedElement>          MappedElements;                                             // 0x04A8   (0x0010)  
	bool                                               bResetTransformBeforeTick;                                  // 0x04B8   (0x0001)  
	bool                                               bResetInitialsBeforeSetup;                                  // 0x04B9   (0x0001)  
	bool                                               bUpdateRigOnTick;                                           // 0x04BA   (0x0001)  
	bool                                               bUpdateInEditor;                                            // 0x04BB   (0x0001)  
	bool                                               bDrawBones;                                                 // 0x04BC   (0x0001)  
	bool                                               bShowDebugDrawing;                                          // 0x04BD   (0x0001)  
	unsigned char                                      UnknownData00_6[0x2];                                       // 0x04BE   (0x0002)  MISSED
	class UControlRig*                                 ControlRig;                                                 // 0x04C0   (0x0008)  
	unsigned char                                      UnknownData01_7[0x68];                                      // 0x04C8   (0x0068)  MISSED


	/// Functions
	// Function /Script/ControlRig.ControlRigComponent.Update
	// void Update(float DeltaTime);                                                                                            // [0x9bdfa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetMappedElements
	// void SetMappedElements(TArray<FControlRigComponentMappedElement> NewMappedElements);                                     // [0x9bdeb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetInitialSpaceTransform
	// void SetInitialSpaceTransform(FName SpaceName, FTransform InitialTransform, EControlRigComponentSpace Space);            // [0x9bdc00] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetInitialBoneTransform
	// void SetInitialBoneTransform(FName BoneName, FTransform InitialTransform, EControlRigComponentSpace Space, bool bPropagateToChildren); // [0x9bda50] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlVector2D
	// void SetControlVector2D(FName ControlName, FVector2D Value);                                                             // [0x9bd980] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlTransform
	// void SetControlTransform(FName ControlName, FTransform Value, EControlRigComponentSpace Space);                          // [0x9bd7f0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlScale
	// void SetControlScale(FName ControlName, FVector Value, EControlRigComponentSpace Space);                                 // [0x9bd6d0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlRotator
	// void SetControlRotator(FName ControlName, FRotator Value, EControlRigComponentSpace Space);                              // [0x9bd5b0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlPosition
	// void SetControlPosition(FName ControlName, FVector Value, EControlRigComponentSpace Space);                              // [0x9bd490] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlOffset
	// void SetControlOffset(FName ControlName, FTransform OffsetTransform, EControlRigComponentSpace Space);                   // [0x9bd300] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlInt
	// void SetControlInt(FName ControlName, int32_t Value);                                                                    // [0x9bd230] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlFloat
	// void SetControlFloat(FName ControlName, float Value);                                                                    // [0x9bd160] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetControlBool
	// void SetControlBool(FName ControlName, bool Value);                                                                      // [0x9bd090] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetBoneTransform
	// void SetBoneTransform(FName BoneName, FTransform Transform, EControlRigComponentSpace Space, float Weight, bool bPropagateToChildren); // [0x9bce90] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.SetBoneInitialTransformsFromSkeletalMesh
	// void SetBoneInitialTransformsFromSkeletalMesh(class USkeletalMesh* InSkeletalMesh);                                      // [0x9bce00] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.OnPreUpdate
	// void OnPreUpdate(class UControlRigComponent* Component);                                                                 // [0x9bcd70] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPreSetup
	// void OnPreSetup(class UControlRigComponent* Component);                                                                  // [0x9bcce0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostUpdate
	// void OnPostUpdate(class UControlRigComponent* Component);                                                                // [0x9bcc50] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostSetup
	// void OnPostSetup(class UControlRigComponent* Component);                                                                 // [0x9bcbc0] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.OnPostInitialize
	// void OnPostInitialize(class UControlRigComponent* Component);                                                            // [0x9bcb30] Native|Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigComponent.Initialize
	// void Initialize();                                                                                                       // [0x9bcb10] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.GetSpaceTransform
	// FTransform GetSpaceTransform(FName SpaceName, EControlRigComponentSpace Space);                                          // [0x9bca00] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetInitialSpaceTransform
	// FTransform GetInitialSpaceTransform(FName SpaceName, EControlRigComponentSpace Space);                                   // [0x9bc8b0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetInitialBoneTransform
	// FTransform GetInitialBoneTransform(FName BoneName, EControlRigComponentSpace Space);                                     // [0x9bc7a0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetElementNames
	// TArray<FName> GetElementNames(ERigElementType ElementType);                                                              // [0x9bc6b0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlVector2D
	// FVector2D GetControlVector2D(FName ControlName);                                                                         // [0x9bc620] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlTransform
	// FTransform GetControlTransform(FName ControlName, EControlRigComponentSpace Space);                                      // [0x9bc510] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlScale
	// FVector GetControlScale(FName ControlName, EControlRigComponentSpace Space);                                             // [0x9bc430] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlRotator
	// FRotator GetControlRotator(FName ControlName, EControlRigComponentSpace Space);                                          // [0x9bc350] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlRig
	// class UControlRig* GetControlRig();                                                                                      // [0x9bc320] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlPosition
	// FVector GetControlPosition(FName ControlName, EControlRigComponentSpace Space);                                          // [0x9bc240] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlOffset
	// FTransform GetControlOffset(FName ControlName, EControlRigComponentSpace Space);                                         // [0x9bc130] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.GetControlInt
	// int32_t GetControlInt(FName ControlName);                                                                                // [0x9bc090] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlFloat
	// float GetControlFloat(FName ControlName);                                                                                // [0x9bbff0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetControlBool
	// bool GetControlBool(FName ControlName);                                                                                  // [0x9bbf50] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetBoneTransform
	// FTransform GetBoneTransform(FName BoneName, EControlRigComponentSpace Space);                                            // [0x9bbe40] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.GetAbsoluteTime
	// float GetAbsoluteTime();                                                                                                 // [0x9bbe10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigComponent.DoesElementExist
	// bool DoesElementExist(FName Name, ERigElementType ElementType);                                                          // [0x9bbd40] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/ControlRig.ControlRigComponent.ClearMappedElements
	// void ClearMappedElements();                                                                                              // [0x9bbd20] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedSkeletalMesh
	// void AddMappedSkeletalMesh(class USkeletalMeshComponent* SkeletalMeshComponent, TArray<FControlRigComponentMappedBone> Bones, TArray<FControlRigComponentMappedCurve> Curves); // [0x9bbb70] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedElements
	// void AddMappedElements(TArray<FControlRigComponentMappedElement> NewMappedElements);                                     // [0x9bba80] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedComponents
	// void AddMappedComponents(TArray<FControlRigComponentMappedComponent> Components);                                        // [0x9bb990] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigComponent.AddMappedCompleteSkeletalMesh
	// void AddMappedCompleteSkeletalMesh(class USkeletalMeshComponent* SkeletalMeshComponent);                                 // [0x9bb900] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	class AActor*                                      ActorToTrack;                                               // 0x0220   (0x0008)  
	class UClass*                                      ControlRigClass;                                            // 0x0228   (0x0008)  
	bool                                               bRefreshOnTick;                                             // 0x0230   (0x0001)  
	bool                                               bIsSelectable;                                              // 0x0231   (0x0001)  
	unsigned char                                      UnknownData00_6[0x6];                                       // 0x0232   (0x0006)  MISSED
	class UMaterialInterface*                          MaterialOverride;                                           // 0x0238   (0x0008)  
	...
	class USceneComponent*                             ActorRootComponent;                                         // 0x0258   (0x0008)  
	class UControlRig*                                 ControlRig;                                                 // 0x0260   (0x0008)  
	TArray<FName>                                      ControlNames;                                               // 0x0268   (0x0010)  
	TArray<FTransform>                                 GizmoTransforms;                                            // 0x0278   (0x0010)  
	TArray<class UStaticMeshComponent*>                Components;                                                 // 0x0288   (0x0010)  
	TArray<class UMaterialInstanceDynamic*>            Materials;                                                  // 0x0298   (0x0010)  
	FName                                              ColorParameterName;                                         // 0x02A8   (0x0008)  
	unsigned char                                      UnknownData02_7[0x8];                                       // 0x02B0   (0x0008)  MISSED


	/// Functions
	// Function /Script/ControlRig.ControlRigControlActor.Refresh
	// void Refresh();                                                                                                          // [0x9c44a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigControlActor.Clear
	// void Clear();                                                                                                            // [0x9c4390] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	class USceneComponent*                             ActorRootComponent;                                         // 0x0220   (0x0008)  
	...
	bool                                               bEnabled : 1;                                               // 0x0244:0 (0x0001)  
	bool                                               bSelected : 1;                                              // 0x0244:1 (0x0001)  
	bool                                               bSelectable : 1;                                            // 0x0244:2 (0x0001)  
	bool                                               bHovered : 1;                                               // 0x0244:3 (0x0001)  
	unsigned char                                      UnknownData00_7[0x3];                                       // 0x0245   (0x0003)  MISSED


	/// Functions
	// Function /Script/ControlRig.ControlRigGizmoActor.SetSelected
	// void SetSelected(bool bInSelected);                                                                                      // [0x9c4750] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetSelectable
	// void SetSelectable(bool bInSelectable);                                                                                  // [0x9c46c0] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetHovered
	// void SetHovered(bool bInHovered);                                                                                        // [0x9c4630] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetGlobalTransform
	// void SetGlobalTransform(FTransform& InTransform);                                                                        // [0x9c4550] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.SetEnabled
	// void SetEnabled(bool bInEnabled);                                                                                        // [0x9c44c0] Native|Public|BlueprintCallable 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnTransformChanged
	// void OnTransformChanged(FTransform& NewTransform);                                                                       // [0x235b330] Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnSelectionChanged
	// void OnSelectionChanged(bool bIsSelected);                                                                               // [0x235b330] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnManipulatingChanged
	// void OnManipulatingChanged(bool bIsManipulating);                                                                        // [0x235b330] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnHoveredChanged
	// void OnHoveredChanged(bool bIsSelected);                                                                                 // [0x235b330] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.OnEnabledChanged
	// void OnEnabledChanged(bool bIsEnabled);                                                                                  // [0x235b330] Event|Public|BlueprintEvent 
	// Function /Script/ControlRig.ControlRigGizmoActor.IsSelectedInEditor
	// bool IsSelectedInEditor();                                                                                               // [0x9c4470] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigGizmoActor.IsHovered
	// bool IsHovered();                                                                                                        // [0x9c4440] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigGizmoActor.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x9c4410] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/ControlRig.ControlRigGizmoActor.GetGlobalTransform
	// FTransform GetGlobalTransform();                                                                                         // [0x9c43b0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x0220 (544 bytes) (0x0001C8 - 0x000220) align 8 MaxSize: 0x0220
class UControlRigSequence : public ULevelSequence
{ 
public:
	TWeakObjectPtr<class UAnimSequence*>               LastExportedToAnimationSequence;                            // 0x01C8   (0x0008)  
	unsigned char                                      UnknownData00_6[0x20];                                      // 0x01D0   (0x0020)  MISSED
	TWeakObjectPtr<class USkeletalMesh*>               LastExportedUsingSkeletalMesh;                              // 0x01F0   (0x0008)  
	unsigned char                                      UnknownData01_6[0x20];                                      // 0x01F8   (0x0020)  MISSED
	float                                              LastExportedFrameRate;                                      // 0x0218   (0x0004)  
	unsigned char                                      UnknownData02_7[0x4];                                       // 0x021C   (0x0004)  MISSED
};

/// Class /Script/ControlRig.ControlRigSequencerAnimInstance
/// Size: 0x02D0 (720 bytes) (0x0002C0 - 0x0002D0) align 16 MaxSize: 0x02D0
...
/// Size: 0x0668 (1640 bytes) (0x000650 - 0x000668) align 8 MaxSize: 0x0668
...
public:
	...
	TArray<FEnumParameterNameAndCurve>                 EnumParameterNamesAndCurves;                                // 0x0260   (0x0010)  
	TArray<FIntegerParameterNameAndCurve>              IntegerParameterNamesAndCurves;                             // 0x0270   (0x0010)  
	unsigned char                                      UnknownData01_7[0x68];                                      // 0x0280   (0x0068)  MISSED
};
...
{ 
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0090   (0x0010)  MISSED
	class UControlRig*                                 ControlRig;                                                 // 0x00A0   (0x0008)  
	class UMovieSceneSection*                          SectionToKey;                                               // 0x00A8   (0x0008)  
	TArray<class UMovieSceneSection*>                  Sections;                                                   // 0x00B0   (0x0010)  
	FName                                              TrackName;                                                  // 0x00C0   (0x0008)  
};
...
static_assert(sizeof(UControlRigComponent) == 0x0530); // 1328 bytes (0x000450 - 0x000530)
static_assert(sizeof(AControlRigControlActor) == 0x02B8); // 696 bytes (0x000220 - 0x0002B8)
...
static_assert(sizeof(UMovieSceneControlRigParameterSection) == 0x02E8); // 744 bytes (0x000148 - 0x0002E8)
static_assert(sizeof(UMovieSceneControlRigParameterTrack) == 0x00C8); // 200 bytes (0x000090 - 0x0000C8)
...
static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x0450);
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x04A8);
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x04C0);
...
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlRigClass) == 0x0150);
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlsMask) == 0x0158);
static_assert(offsetof(UMovieSceneControlRigParameterSection, TransformMask) == 0x0168);
static_assert(offsetof(UMovieSceneControlRigParameterSection, Weight) == 0x0170);
static_assert(offsetof(UMovieSceneControlRigParameterSection, ControlChannelMap) == 0x0210);
static_assert(offsetof(UMovieSceneControlRigParameterSection, EnumParameterNamesAndCurves) == 0x0260);
static_assert(offsetof(UMovieSceneControlRigParameterSection, IntegerParameterNamesAndCurves) == 0x0270);
static_assert(offsetof(UMovieSceneControlRigParameterTrack, ControlRig) == 0x00A0);
static_assert(offsetof(UMovieSceneControlRigParameterTrack, SectionToKey) == 0x00A8);
static_assert(offsetof(UMovieSceneControlRigParameterTrack, Sections) == 0x00B0);
static_assert(offsetof(UMovieSceneControlRigParameterTrack, TrackName) == 0x00C0);
