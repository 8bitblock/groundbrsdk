...
{ 
	SDK_UNDEFINED(80,888) /* TSet<FString> */          __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,889) /* TSet<int32_t> */          __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,890) /* TSet<FName> */            __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,891) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                          // 0x00F0   (0x0050)  
};
