...
public:
	...
	SDK_UNDEFINED(16,306) /* FMulticastInlineDelegate */ __um(OnActorFracture);                                    // 0x0228   (0x0010)  
};

/// Class /Script/ApexDestruction.DestructibleComponent
/// Size: 0x0780 (1920 bytes) (0x0006A0 - 0x000780) align 16 MaxSize: 0x0780
...
public:
	...
	SDK_UNDEFINED(16,307) /* FMulticastInlineDelegate */ __um(OnComponentFracture);                                // 0x06D0   (0x0010)  
	...
	// void SetDestructibleMesh(class UDestructibleMesh* NewMesh);                                                              // [0x8e6c50] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.GetDestructibleMesh
	// class UDestructibleMesh* GetDestructibleMesh();                                                                          // [0x8e6c20] Final|Native|Public|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyRadiusDamage
	// void ApplyRadiusDamage(float BaseDamage, FVector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage); // [0x8e6a60] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/ApexDestruction.DestructibleComponent.ApplyDamage
	// void ApplyDamage(float DamageAmount, FVector& HitLocation, FVector& ImpulseDir, float ImpulseStrength);                  // [0x8e68e0] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
