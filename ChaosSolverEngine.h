...
{ 
	...
	SDK_UNDEFINED(80,379) /* TSet<UObject*> */         __um(ChaosHandlers);                                        // 0x0008   (0x0050)  
};
...
/// Size: 0x0270 (624 bytes) (0x0000B8 - 0x000270) align 8 MaxSize: 0x0270
class UChaosGameplayEventDispatcher : public UChaosEventListenerComponent
{ 
public:
	unsigned char                                      UnknownData00_8[0x110];                                     // 0x00B8   (0x0110)  MISSED
	TMap<class UPrimitiveComponent*, FChaosHandlerSet> CollisionEventRegistrations;                                // 0x01C8   (0x0050)  
	TMap<class UPrimitiveComponent*, FBreakEventCallbackWrapper> BreakEventRegistrations;                          // 0x0218   (0x0050)  
...
public:
	...
	// FHitResult ConvertPhysicsCollisionToHitResult(FChaosPhysicsCollisionInfo& PhysicsCollision);                             // [0x4814f40] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetSolverActive(bool bActive);                                                                                      // [0x9c44c0] Native|Public|BlueprintCallable 
	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetAsCurrentWorldSolver
	// void SetAsCurrentWorldSolver();                                                                                          // [0x4815030] Final|Native|Public|BlueprintCallable 
};
