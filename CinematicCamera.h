...
public:
	...
	// class USplineComponent* GetRailSplineComponent();                                                                        // [0x1f31200] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
/// Size: 0x0810 (2064 bytes) (0x0007B0 - 0x000810) align 16 MaxSize: 0x0810
...
public:
	...
	// class UCineCameraComponent* GetCineCameraComponent();                                                                    // [0x3981a10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x08D0 (2256 bytes) (0x0007D0 - 0x0008D0) align 16 MaxSize: 0x08D0
...
public:
	...
	// void SetLensPresetByName(FString InPresetName);                                                                          // [0x3981f10] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.SetFilmbackPresetByName
	// void SetFilmbackPresetByName(FString InPresetName);                                                                      // [0x3981e70] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.SetCurrentFocalLength
	// void SetCurrentFocalLength(float InFocalLength);                                                                         // [0x3981df0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetVerticalFieldOfView
	// float GetVerticalFieldOfView();                                                                                          // [0x3981dc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetLensPresetsCopy
	// TArray<FNamedLensPreset> GetLensPresetsCopy();                                                                           // [0x3981cc0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetLensPresetName
	// FString GetLensPresetName();                                                                                             // [0x3981c70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetHorizontalFieldOfView
	// float GetHorizontalFieldOfView();                                                                                        // [0x3981c40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetFilmbackPresetsCopy
	// TArray<FNamedFilmbackPreset> GetFilmbackPresetsCopy();                                                                   // [0x3981b40] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetFilmbackPresetName
	// FString GetFilmbackPresetName();                                                                                         // [0x3981af0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CinematicCamera.CineCameraComponent.GetDefaultFilmbackPresetName
	// FString GetDefaultFilmbackPresetName();                                                                                  // [0x3981a30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
